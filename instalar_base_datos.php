<?php
/**
 * Script para crear automáticamente las tablas de facturas
...
<head>
    ...
    <title>Instalación de Base de Datos - Sistema de Facturas</title>
        ...
        <div class='install-card'>
            <div class='card'>
                <div class='card-header bg-primary text-white'>
                    <h2><i class='fas fa-database'></i> Instalación de Base de Datos - Sistema de Facturas</h2>
                </div>
                <div class='card-body'>";
...
try {
    ...
    } else if ($countFacturas['total'] == 0) {
        echo "<div class='log-info log-item'>📝 Insertando factura de ejemplo sin cliente...</div>";
        
        $ejemploFactura = "
        INSERT INTO facturas (numero_factura, cliente_nombre, cliente_email, subtotal, impuesto, total, metodo_pago, estado, notas) VALUES
        ('FAC-" . date('Ymd') . "-0001', 'Cliente de Ejemplo', 'ejemplo@correo.com', 100.00, 16.00, 116.00, 'efectivo', 'pagada', 'Factura de ejemplo del sistema')";
    ...
    echo "<div class='mt-4 p-3 bg-light border rounded'>
        ...
        <ul>
            ...
            <li>✅ Relaciones entre tablas establecidas</li>
